...
const RateMe = () => {
  return (
    <RateMeWrapper>
      <p>rate me demo</p>
      <svg width='48' height='40.32' viewBox='0 0 50 42' fill='none' style={{ transform: 'rotate(0deg)' }} className={'rate-me-btn'}>
        <defs>
          <linearGradient id='active-gradient-jjqi' x1='25' y1='42' x2='26.3796' y2='0.0453673'
                          gradientUnits='userSpaceOnUse'>
            <stop stopColor='hsl(353deg, 100%, 52%)' />
            <stop offset='1' stopColor='hsl(313deg, 100%, 52%)' />
          </linearGradient>
          <linearGradient id='inactive-gradient-jjqi' x1='15' y1='41' x2='42' y2='-1.5' gradientUnits='userSpaceOnUse'>
            <stop stopColor='#666' stopOpacity='0.4' />
            <stop offset='1' stopColor='#AAA' stopOpacity='0.4' />
          </linearGradient>
        </defs>
        <mask id='like-button-mask-jjqi' mask-type='alpha' maskUnits='userSpaceOnUse' x='0' y='0' width='50'
              height='42'>
          <path
        ...
        <mask id='active-gradient-mask-jjqi' mask-type='alpha' maskUnits='userSpaceOnUse' x='0' y='0' width='50'
              height='42'>
          <polygon points='
                0,42
                50,42
        ...
        <g mask='url(#like-button-mask-jjqi)'>
          <path
            d='M13.2537 0.0255029C23.4033 0.0255029 25.0273 10.5191 25.0273 10.5191C25.0273 10.5191 26.6512 -0.60088 37.6129 0.0255029C44.3441 0.410148 48.7484 6.32169 48.9804 12.1981C49.7924 32.7656 28.7678 41.5 25.0273 41.5C21.2868 41.5 -0.549833 32.3459 1.07416 12.1981C1.54782 6.32169 6.29929 0.0255029 13.2537 0.0255029Z'
            fill='url(#inactive-gradient-jjqi)' />
          <g mask='url(#active-gradient-mask-jjqi)'>
            <path
              d='M13.2537 0.0255029C23.4033 0.0255029 25.0273 10.5191 25.0273 10.5191C25.0273 10.5191 26.6512 -0.60088 37.6129 0.0255029C44.3441 0.410148 48.7484 6.32169 48.9804 12.1981C49.7924 32.7656 28.7678 41.5 25.0273 41.5C21.2868 41.5 -0.549833 32.3459 1.07416 12.1981C1.54782 6.32169 6.29929 0.0255029 13.2537 0.0255029Z'
              fill='url(#active-gradient-jjqi)' />
          </g>
          <g style={{
          ...
          <g style={{ opacity: 0 }}>
            <path d='M 13 23 Q 15 19, 17 23 ' stroke='#000000' strokeOpacity='0.4' fill='none' strokeLinecap='round'
                  strokeLinejoin='round' strokeWidth='2' />
            <path d='M 33 23 Q 35 19, 37 23 ' stroke='#000000' strokeOpacity='0.4' fill='none' strokeLinecap='round'
                  strokeLinejoin='round' strokeWidth='2' />
          </g>
          <g>
            ...
            M 20 30
            Q 25 33.6 30 30
          ' stroke='#000000' strokeOpacity='0.4' strokeLinecap='round' style={{ opacity: 1 }} />
          </g>
          <g>
            <path
            ...
            <path
              ...
              stroke='white' strokeOpacity='0.45' strokeWidth='3' strokeLinecap='round'
              strokeLinejoin='round' />
            <path d='M31.7084 5.95975C32.7822 4.70067 34.1021 3.81419 35.484 3.37609' stroke='white'
                  strokeOpacity='0.45' strokeWidth='3' strokeLinecap='round' strokeLinejoin='round' />
          </g>
        </g>
      </svg>
    </RateMeWrapper>
...
const RateMeWrapper = styled.div`
